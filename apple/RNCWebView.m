...
//}
    ...
    CGRect popUpToolBarFrame = CGRectMake(5, self.webView.frame.origin.y+5, self.webView.frame.size.width-10, 30); //popUpToolBarFrame
    self.popupToolBarView = [[UIView alloc]initWithFrame:popUpToolBarFrame];
    
    CGRect centerCloseBtnFrame = CGRectMake(self.popupToolBarView.frame.size.width/2 -60, 0, 120, 30); //Center Close Btn
//    CGRect fullCloseBtnFrame = CGRectMake(5, 0, self.popupToolBarView.frame.size.width-10, 30); //FullClose Btn
    CGRect rightCloseBtnFrame = CGRectMake(self.popupToolBarView.frame.size.width-50, 0, 50, 30);//left close Btn
    CGRect leftCloseBtnFrame = CGRectMake(0, 0, 40, 30);//left close Btn
    ...
    [self.closeBtn setFrame:rightCloseBtnFrame];
...
//    [self.closeBtn setTitle:@"x" forState:UIControlStateNormal]; ////left close Btn
    [self.closeBtn.titleLabel setFont:[UIFont fontWithName:@"Helvetica-Bold" size:20.0]];
...
//    [self.closeBtn setTitle:@"x" forState:UIControlStateNormal]; ////left close Btn
    ...
    CGRect ppwebviewrect = CGRectMake(webView.frame.origin.x+5, webView.frame.origin.y+32, webView.frame.size.width-10, webView.frame.size.height-34);
    if(_showCustomBottomBar){
        ppwebviewrect = CGRectMake(webView.frame.origin.x+5, webView.frame.origin.y+32, webView.frame.size.width-10, webView.frame.size.height);
    }
